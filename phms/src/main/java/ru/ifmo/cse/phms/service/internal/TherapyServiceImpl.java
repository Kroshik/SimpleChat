...
import ru.ifmo.cse.phms.domain.therapy.Condition;
import ru.ifmo.cse.phms.domain.therapy.Experiment;
import ru.ifmo.cse.phms.domain.therapy.Patient;
import ru.ifmo.cse.phms.repository.therapy.ConditionRepository;
import ru.ifmo.cse.phms.repository.therapy.ExperimentRepository;
import ru.ifmo.cse.phms.repository.therapy.PatientRepository;
import ru.ifmo.cse.phms.service.TherapyService;
import ru.ifmo.cse.phms.util.DateUtils;
import ru.ifmo.cse.phms.util.RandomUtils;
